...
### [ ] 2. `build: migrate pyproject.toml from Poetry to uv/hatchling`
...
### [ ] 3. `build: migrate Makefile from Poetry to uv`
...
### [ ] 4. `feat: add MLXWhisperBackend for Apple Silicon`
...
### [ ] 5. `refactor: move decode_audio import into convert_audio()`
...
### [ ] 6. `feat: add --backend option to transcribe CLI command`
...
### [ ] 7. `docs: update README install instructions for uv`
...
### [ ] 8. `docs: update research.md with mlx backend and uv sections`
